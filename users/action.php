        ...
        if ($tbcamera) { 
            foreach($tbcamera as $row) {
                $output .= '<tr>
                            ...
                            <td>
                                <a href="#" id="'. $row['id_camera'] .'" class="btn btn-success btn-sm rounded-pull py-0 editlink" data-bs-toggle="modal" data-bs-target="#editCameraModal"><i
                                class="fa-solid fa-pen-to-square"></i></a>
                                <a href="#" id="'. $row['id_camera'] .'" class="btn btn-danger btn-sm rounded-pull py-0 deletelink"><i class="fa-solid fa-trash-can"></i></a>
                            </td>
                </tr>';
            }
            echo $output;
