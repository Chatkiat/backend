<?php 
    ...
    class DB_con {
        ...
        public function count(){
            $result= mysqli_query($this->dbcon,"SELECT count(*) as total from tbcamera where status_cm like 'on'");
                return $result;
               
        }

        public function count_off(){
            $result= mysqli_query($this->dbcon,"SELECT count(*) as total from tbcamera where status_cm like 'off'");
                return $result;
